...
/*
	...
	*/
	...
	void answers(const int* year, const int* population, const int* violentCrime,
		...
		cout.setf(ios::fixed);
		cout.precision(2);
		cout << static_cast<double>(total_population) / 1000000 << " million" << endl;




		// Q2. print whether violent crime rate has gone up or down between 2000 and 2005
		const char *change = violentCrime[0] < violentCrime[n - 1] ? "up" : "down";
		cout << "Violent Crime trend is " << change << endl;
		...
		double average_theft= 0;
		cout << "There are ";
		average_theft = average(grandTheftAuto, n);
		cout.precision(2);
		cout << fixed << average_theft / 1000000 << " million Grand Theft Auto incidents on average a year" << endl;
